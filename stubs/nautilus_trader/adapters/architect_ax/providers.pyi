...
class AxInstrumentProvider(InstrumentProvider):
    def __init__(self, client: nautilus_pyo3.AxHttpClient, config: InstrumentProviderConfig | None = None, maker_fee: Decimal | None = None, taker_fee: Decimal | None = None) -> None: ...
