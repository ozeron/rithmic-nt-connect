...
from nautilus_trader.adapters.kraken.config import KrakenExecClientConfig as KrakenExecClientConfig
...
from nautilus_trader.model.enums import AccountType as AccountType, OmsType as OmsType, OrderSide as OrderSide, OrderStatus as OrderStatus, OrderType as OrderType, PositionSide as PositionSide, TimeInForce as TimeInForce, TriggerType as TriggerType, order_side_to_str as order_side_to_str
...
from nautilus_trader.model.functions import account_type_to_pyo3 as account_type_to_pyo3, order_side_to_pyo3 as order_side_to_pyo3, order_type_to_pyo3 as order_type_to_pyo3, time_in_force_to_pyo3 as time_in_force_to_pyo3, trigger_type_to_pyo3 as trigger_type_to_pyo3
from nautilus_trader.model.identifiers import AccountId as AccountId, ClientId as ClientId, ClientOrderId as ClientOrderId, InstrumentId as InstrumentId, VenueOrderId as VenueOrderId
...
class KrakenExecutionClient(LiveExecutionClient):
    ...
    def __init__(self, loop: asyncio.AbstractEventLoop, http_client_spot: nautilus_pyo3.KrakenSpotHttpClient | None, http_client_futures: nautilus_pyo3.KrakenFuturesHttpClient | None, msgbus: MessageBus, cache: Cache, clock: LiveClock, instrument_provider: KrakenInstrumentProvider, config: KrakenExecClientConfig, name: str | None) -> None: ...
    @property
