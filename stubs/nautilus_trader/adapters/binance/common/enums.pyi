...
from nautilus_trader.model.data import BarSpecification as BarSpecification
from nautilus_trader.model.enums import BarAggregation as BarAggregation, OrderSide as OrderSide, OrderStatus as OrderStatus, OrderType as OrderType, PriceType as PriceType, TimeInForce as TimeInForce, TriggerType as TriggerType, bar_aggregation_to_str as bar_aggregation_to_str
...
class BinanceEnumParser:
    ext_to_int_status: Incomplete
    ext_to_int_order_side: Incomplete
    int_to_ext_order_side: Incomplete
    ext_to_int_bar_agg: Incomplete
    int_to_ext_bar_agg: Incomplete
    ext_to_int_time_in_force: Incomplete
    int_to_ext_time_in_force: Incomplete
    ...
    def parse_binance_kline_interval_to_bar_spec(self, kline_interval: BinanceKlineInterval) -> BarSpecification: ...
    def parse_binance_trigger_type(self, trigger_type: str) -> TriggerType: ...
    def parse_position_id_to_binance_futures_position_side(self, position_id: PositionId) -> BinanceFuturesPositionSide: ...
