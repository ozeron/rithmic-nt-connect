...
class OptionSpread(nautilus_trader.model.instruments.base.Instrument):
    __pyx_vtable__: ClassVar[PyCapsule] = ...
    activation_ns: Incomplete
    activation_utc: OptionSpread.activation_utc
    exchange: Incomplete
    expiration_ns: Incomplete
    expiration_utc: OptionSpread.expiration_utc
    ...
    @staticmethod
    def from_dict(dictvalues) -> OptionSpread: ...
    @staticmethod
    def from_pyo3(pyo3_instrument) -> OptionSpread: ...
    def legs(self) -> list: ...
    @staticmethod
    def to_dict(OptionSpreadobj) -> dict[str, object]: ...
    def __reduce__(self): ...
